...
# 加载ResNet-50模型（不包括顶层分类器）
base_model = ResNet50(weights='imagenet', include_top=False)

# 定义输入张量的形状
input_shape = (256, 256, 3)  # ResNet-50接受3通道的图像，所以将灰度图转换为RGB图像

# 加载灰度图像并转换为RGB图像
img_path = '3_6_4_7.jpg'  # 替换为你的图像路径
...
# 获取ResNet-50模型的某一层的输出
layer_name = 'conv5_block3_out'  # 选择合适的层
